...
////// Emissive:
                ...
                float3 node_6108 = lerp(node_544,_FresnelColor.rgb,pow(1.0-max(0,dot(normalDirection, viewDirection)),_Fresnel));
                float3 BCol = node_6108;
